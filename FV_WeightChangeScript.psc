...
Function UpdateThiccnessMeter(WeightData data)
	...
	If(data.AtomicBEnabled)
		...
		if((fABBreastMin-fABBreastMax) != 0)
			UpdatedThiccnessMeter += (fABBreastMin - data.CurrentABBreast)/(fABBreastMin - fABBreastMax)
			UpdatedMaxThiccness += 1
		EndIf
		if((fABBreastHugeMin-fABBreastHugeMax) != 0)
			UpdatedThiccnessMeter += (fABBreastHugeMin - data.CurrentABBreastHuge)/(fABBreastHugeMin - fABBreastHugeMax)
			UpdatedMaxThiccness += 1
		EndIf
		if((fABThighSlimMin-fABThighSlimMax) != 0)
			UpdatedThiccnessMeter += (fABThighSlimMin - data.CurrentABThighSlim)/(fABThighSlimMin - fABThighSlimMax) 
			UpdatedMaxThiccness += 1
		EndIf
		If((fABNarrowWaistMin-fABNarrowWaistMax) != 0)
			UpdatedThiccnessMeter += (fABNarrowWaistMin - data.CurrentABNarrowWaist)/(fABNarrowWaistMin - fABNarrowWaistMax)
			UpdatedMaxThiccness += 1
		EndIf
		If((fABButtHugeMin-fABButtHugeMax) != 0)
			UpdatedThiccnessMeter += (fABButtHugeMin - data.CurrentABButtHuge)/(fABButtHugeMin - fABButtHugeMax)
			UpdatedMaxThiccness += 1
		EndIf
		If((fABBackWideMin-fABBackWideMax) != 0)
			UpdatedThiccnessMeter += (fABBackWideMin - data.CurrentABBackWide)/(fABBackWideMin - fABBackWideMax)
			UpdatedMaxThiccness += 1
		EndIf
		If((fABBellySizeMin-fABBellySizeMax) != 0)
			UpdatedThiccnessMeter += (fABBellySizeMin - data.CurrentABBellySize)/(fABBellySizeMin - fABBellySizeMax)
			UpdatedMaxThiccness += 1
		EndIf
		If((fABButtFlatMin-fABButtFlatMax) != 0)
			UpdatedThiccnessMeter += (fABButtFlatMin - data.CurrentABButtFlat)/(fABButtFlatMin - fABButtFlatMax)
			UpdatedMaxThiccness += 1
		EndIf
		If((fABButtStretchMin-fABButtStretchMax) != 0)
			UpdatedThiccnessMeter += (fABButtStretchMin - data.CurrentABButtStretch)/(fABButtStretchMin - fABButtStretchMax)
			UpdatedMaxThiccness += 1
		EndIf
		If((fABButtWideMin-fABButtWideMax) != 0)
			UpdatedThiccnessMeter += (fABButtWideMin - data.CurrentABButtWide)/(fABButtWideMin - fABButtWideMax)
			UpdatedMaxThiccness += 1
		EndIf
		If((fABHipsWideMin-fABHipsWideMax) != 0)
			UpdatedThiccnessMeter += (fABHipsWideMin - data.CurrentABHipsWide)/(fABHipsWideMin - fABHipsWideMax)
			UpdatedMaxThiccness += 1
		EndIf
		If((fABTorsoLargeMin-fABTorsoLargeMin) != 0)
			UpdatedThiccnessMeter += (fABTorsoLargeMin - data.CurrentABTorsoLarge)/(fABTorsoLargeMin - fABTorsoLargeMax)
			UpdatedMaxThiccness += 1
		EndIf
		If((fABWaistHeightMin-fABWaistHeightMax) != 0)
			UpdatedThiccnessMeter += (fABWaistHeightMin - data.CurrentABWaistHeight)/(fABWaistHeightMin - fABWaistHeightMax)
			UpdatedMaxThiccness += 1
		EndIf
		If((fABWaistSmoothMin-fABWaistSmoothMax) != 0)
			UpdatedThiccnessMeter += (fABWaistSmoothMin - data.CurrentABWaistSmooth)/(fABWaistSmoothMin - fABWaistSmoothMax)
			UpdatedMaxThiccness += 1
		EndIf
...
Function ShapeSettingReset()
	fABSlimMin = MCM.GetModSettingFloat(sModNameMCM, "fABSlimMin:AtomicBeauty")
	fABSlimMax = MCM.GetModSettingFloat(sModNameMCM, "fABSlimMax:AtomicBeauty")
	fABBreastMin = MCM.GetModSettingFloat(sModNameMCM, "fABBreastMin:AtomicBeauty")
	fABBreastMax = MCM.GetModSettingFloat(sModNameMCM, "fABBreastMax:AtomicBeauty")
	fABBreastHugeMin = MCM.GetModSettingFloat(sModNameMCM, "fABBreastHugeMin:AtomicBeauty")
	fABBreastHugeMax = MCM.GetModSettingFloat(sModNameMCM, "fABBreastHugeMax:AtomicBeauty")
	fABThighSlimMin = MCM.GetModSettingFloat(sModNameMCM, "fABThighSlimMin:AtomicBeauty")
	fABThighSlimMax = MCM.GetModSettingFloat(sModNameMCM, "fABThighSlimMax:AtomicBeauty")
	fABNarrowWaistMin = MCM.GetModSettingFloat(sModNameMCM, "fABNarrowWaistMin:AtomicBeauty")
	fABNarrowWaistMax = MCM.GetModSettingFloat(sModNameMCM, "fABNarrowWaistMax:AtomicBeauty")
	fABButtHugeMin = MCM.GetModSettingFloat(sModNameMCM, "fABButtHugeMin:AtomicBeauty")
	fABButtHugeMax = MCM.GetModSettingFloat(sModNameMCM, "fABButtHugeMax:AtomicBeauty")
	fABBackWideMax = MCM.GetModSettingFloat(sModNameMCM, "fABBackWideMax:AtomicBeauty")
	fABBackWideMin = MCM.GetModSettingFloat(sModNameMCM, "fABBackWideMin:AtomicBeauty")
	fABBellySizeMax = MCM.GetModSettingFloat(sModNameMCM, "fABBellySizeMax:AtomicBeauty")
	fABBellySizeMin = MCM.GetModSettingFloat(sModNameMCM, "fABBellySizeMin:AtomicBeauty")
	fABButtFlatMax = MCM.GetModSettingFloat(sModNameMCM, "fABButtFlatMax:AtomicBeauty")
	fABButtFlatMin = MCM.GetModSettingFloat(sModNameMCM, "fABButtFlatMin:AtomicBeauty")
	fABButtStretchMax = MCM.GetModSettingFloat(sModNameMCM, "fABButtStretchMax:AtomicBeauty")
	fABButtStretchMin = MCM.GetModSettingFloat(sModNameMCM, "fABButtStretchMin:AtomicBeauty")
	fABButtWideMax = MCM.GetModSettingFloat(sModNameMCM, "fABButtWideMax:AtomicBeauty")
	fABButtWideMin = MCM.GetModSettingFloat(sModNameMCM, "fABButtWideMin:AtomicBeauty")
	fABHipsWideMax = MCM.GetModSettingFloat(sModNameMCM, "fABHipsWideMax:AtomicBeauty")
	fABHipsWideMin = MCM.GetModSettingFloat(sModNameMCM, "fABHipsWideMin:AtomicBeauty")
	fABTorsoLargeMax = MCM.GetModSettingFloat(sModNameMCM, "fABTorsoLargeMax:AtomicBeauty")
	fABTorsoLargeMin = MCM.GetModSettingFloat(sModNameMCM, "fABTorsoLargeMin:AtomicBeauty")
	fABWaistHeightMax = MCM.GetModSettingFloat(sModNameMCM, "fABWaistHeightMax:AtomicBeauty")
	fABWaistHeightMin = MCM.GetModSettingFloat(sModNameMCM, "fABWaistHeightMin:AtomicBeauty")
	fABWaistSmoothMax = MCM.GetModSettingFloat(sModNameMCM, "fABWaistSmoothMax:AtomicBeauty")
	fABWaistSmoothMin = MCM.GetModSettingFloat(sModNameMCM, "fABWaistSmoothMin:AtomicBeauty")
	fABWaistWideMax = MCM.GetModSettingFloat(sModNameMCM, "fABWaistWideMax:AtomicBeauty")
	fABWaistWideMin = MCM.GetModSettingFloat(sModNameMCM, "fABWaistWideMin:AtomicBeauty")
	
	fCBBE7BUpperMin = MCM.GetModSettingFloat(sModNameMCM, "fCBBE7BUpperMin:CBBE")
	fCBBE7BUpperMax = MCM.GetModSettingFloat(sModNameMCM, "fCBBE7BUpperMax:CBBE")
	fCBBE7BLowerMin = MCM.GetModSettingFloat(sModNameMCM, "fCBBE7BLowerMin:CBBE")
	fCBBE7BLowerMax = MCM.GetModSettingFloat(sModNameMCM, "fCBBE7BLowerMax:CBBE")
	fCBBEBreastsSmallMin = MCM.GetModSettingFloat(sModNameMCM, "fCBBEBreastsSmallMin:CBBE")
	fCBBEBreastsSmallMax = MCM.GetModSettingFloat(sModNameMCM, "fCBBEBreastsSmallMax:CBBE")
	fCBBEHipsMin = MCM.GetModSettingFloat(sModNameMCM, "fCBBEHipsMin:CBBE")
	fCBBEHipsMax = MCM.GetModSettingFloat(sModNameMCM, "fCBBEHipsMax:CBBE")
	fCBBECalfMin = MCM.GetModSettingFloat(sModNameMCM, "fCBBECalfMin:CBBE")
	fCBBECalfMax = MCM.GetModSettingFloat(sModNameMCM, "fCBBECalfMax:CBBE")
	fCBBEChubbyLegsMin = MCM.GetModSettingFloat(sModNameMCM, "fCBBEChubbyLegsMin:CBBE")
	fCBBEChubbyLegsMax = MCM.GetModSettingFloat(sModNameMCM, "fCBBEChubbyLegsMax:CBBE")
	fCBBEButtSmallMin = MCM.GetModSettingFloat(sModNameMCM, "fCBBEButtSmallMin:CBBE")
	fCBBEButtSmallMax = MCM.GetModSettingFloat(sModNameMCM, "fCBBEButtSmallMax:CBBE")
	fCBBESlimThighsMin = MCM.GetModSettingFloat(sModNameMCM, "fCBBESlimThighsMin:CBBE")
	fCBBESlimThighsMax = MCM.GetModSettingFloat(sModNameMCM, "fCBBESlimThighsMax:CBBE")
	fCBBEAppleCheeksMin = MCM.GetModSettingFloat(sModNameMCM, "fCBBEAppleCheeksMin:CBBE")
	fCBBEAppleCheeksMax = MCM.GetModSettingFloat(sModNameMCM, "fCBBEAppleCheeksMax:CBBE")
	fCBBEBigButtMin = MCM.GetModSettingFloat(sModNameMCM, "fCBBEBigButtMin:CBBE")
	fCBBEBigButtMax = MCM.GetModSettingFloat(sModNameMCM, "fCBBEBigButtMax:CBBE")
	fCBBEBreastWidthMin = MCM.GetModSettingFloat(sModNameMCM, "fCBBEBreastWidthMin:CBBE")
	fCBBEBreastWidthMax = MCM.GetModSettingFloat(sModNameMCM, "fCBBEBreastWidthMax:CBBE")
	fCBBEChestDepthMin = MCM.GetModSettingFloat(sModNameMCM, "fCBBEChestDepthMin:CBBE")
	fCBBEChestDepthMax = MCM.GetModSettingFloat(sModNameMCM, "fCBBEChestDepthMax:CBBE")
	fCBBEChubbyArmsMin = MCM.GetModSettingFloat(sModNameMCM, "fCBBEChubbyArmsMin:CBBE")
	fCBBEChubbyArmsMax = MCM.GetModSettingFloat(sModNameMCM, "fCBBEChubbyArmsMax:CBBE")
	fCBBEForearmSizeMin = MCM.GetModSettingFloat(sModNameMCM, "fCBBEForearmSizeMin:CBBE")
	fCBBEForearmSizeMax = MCM.GetModSettingFloat(sModNameMCM, "fCBBEForearmSizeMax:CBBE")
	fCBBEPushUpMin = MCM.GetModSettingFloat(sModNameMCM, "fCBBEPushUpMin:CBBE")
	fCBBEPushUpMax = MCM.GetModSettingFloat(sModNameMCM, "fCBBEPushUpMax:CBBE")
	fCBBEBreastPerkinessMin = MCM.GetModSettingFloat(sModNameMCM, "fCBBEBreastPerkinessMin:CBBE")
	fCBBEBreastPerkinessMax = MCM.GetModSettingFloat(sModNameMCM, "fCBBEBreastPerkinessMax:CBBE")
	fCBBEWaistMin = MCM.GetModSettingFloat(sModNameMCM, "fCBBEWaistMin:CBBE")
	fCBBEWaistMax = MCM.GetModSettingFloat(sModNameMCM, "fCBBEWaistMax:CBBE")
	fCBBESSBBW2Min = MCM.GetModSettingFloat(sModNameMCM, "fCBBESSBBW2Min:CBBE")
	fCBBESSBBW2Max = MCM.GetModSettingFloat(sModNameMCM, "fCBBESSBBW2Max:CBBE")
	fCBBEGiantBellyMin = MCM.GetModSettingFloat(sModNameMCM, "fCBBEGiantBellyMin:CBBE")
	fCBBEGiantBellyMax = MCM.GetModSettingFloat(sModNameMCM, "fCBBEGiantBellyMax:CBBE")
	fCBBEBreastsMin = MCM.GetModSettingFloat(sModNameMCM, "fCBBEBreastsMin:CBBE")
	fCBBEBreastsMax = MCM.GetModSettingFloat(sModNameMCM, "fCBBEBreastsMax:CBBE")
	fCBBEBreastFantasyMin = MCM.GetModSettingFloat(sModNameMCM, "fCBBEBreastFantasyMin:CBBE")
	fCBBEBreastFantasyMax = MCM.GetModSettingFloat(sModNameMCM, "fCBBEBreastFantasyMax:CBBE")
	fCBBEUltKirBodyMin = MCM.GetModSettingFloat(sModNameMCM, "fCBBEUltKirBodyMin:CBBE")
	fCBBEUltKirBodyMax = MCM.GetModSettingFloat(sModNameMCM, "fCBBEUltKirBodyMax:CBBE")
	MCM.RefreshMenu()
EndFunction
